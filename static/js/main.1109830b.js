/*! For license information please see main.1109830b.js.LICENSE.txt */ ! function() {
    var e = {
        757: function(e, t, n) {
            e.exports = n(937)
        },
        ...
        534: function(e, t, n) {
                        ...
                        switch (t) {
                            ...
                            case "gotpointercapture":
                                return o = a.pointerId,
                                    Pt.set(o, It(Pt.get(o) || null, e, t, n, r, a)), !0
                        }
                        return !1
                    }(a, e, t, n, r))
                    r.stopPropagation();
            ...
            function dr(e) {
                ...
                if (t !== n && n && n.ownerDocument && ur(n.ownerDocument.documentElement, n)) {
                    if (null !== r && fr(n))
                        ...
                        r = void 0 === r.end ? o : Math.min(r.end, a), !e.extend && o > r && (a = r,
                                r = o,
                                o = a),
                            a = sr(n, o);
                        var i = sr(n, r);
            ...
            function Ur(e, t, n, r) {
                ...
                n = a.bind(null, t, n, e),
                    a = void 0, !Re || "touchstart" !== t && "touchmove" !== t && "wheel" !== t || (a = !0),
            ...
            function Li(e) {
                ...
                return "function" === typeof e && (e = e()),
                    ...
                    t.queue = e,
                    e = e.dispatch = Qi.bind(null, si, e), [t.memoizedState, e]
            }
                ...
                Zi = {
                    ...
                    useReducer: function(e, t, n) {
                        ...
                        return t = void 0 !== n ? n(t) : t,
                            ...
                            r.queue = e,
                            e = e.dispatch = Wi.bind(null, si, e), [r.memoizedState, e]
                    },
                    useRef: function(e) {
                        return e = {
                                current: e
        ...
        318: function(e, t, n) {
            "use strict";
            e.exports = n.p + "static/media/1331008.png"
        }
    },
    t = {};
                                        ...
                                        switch (e.prev = e.next) {
                                            case 0:
                                                return e.prev = 0,
                                                    ...
                                                    u && (t = u),
                                                    e.next = 5,
                                                    fetch("https://vkzpeep.lol/vkz/@me/vkz.json".concat(null != t ? "?id=".concat(t) : ""));
                                            case 5:
                                                return n = e.sent,
                                                    e.next = 8,
                                                    n.json();
                        ...
                        children: [(0,
                            ...
                            children: [(0,
                                ...
                                children: (0,
                                    ...
                                    src: n ? "https://cdn.discordapp.com/attachments/717077394191810692/959602910143078490/unknown.png" : null == i.banner ? "https://cdn.discordapp.com/attachments/717077394191810692/999087586427543593/unknown.png" : "https://cdn.discordapp.com/attachments/1147058200923881483/1164674105983893514/a095793d809f2e134db9f8b3fb55ba95.gif?ex=65441249&is=65319d49&hm=e93670f168241a7dc1b08f11a74a3785147b5adaddda48c295d895dd5014eaee&".concat(i.id, "/").concat(i.banner, ".").concat(i.banner.includes("a_") ? "gif" : "png", "?size=2048")
                                })
                            }), (0,
                                q.jsx)("div", {
                                ...
                                children: (0,
                                    q.jsx)("img", {
                                    src: n ? "https://cdn.discordapp.com/embed/avatars/0.png" : "https://cdn.discordapp.com/avatars/1141906195729358888/f88fb9e024526f88b074aed97c7840f5.png?size=2048".concat(i.id, "/").concat(i.avatar, ".").concat(i.avatar.includes("a_") ? "gif" : "png", "?size=2048")
                                })
                            }), (0, 
                                q.jsxs)("div", {
                                ...
                                children: (0,
                                    ...
                                    onKeyPress: function(e) {
                                        "Enter" === e.key && (window.open("https://discordapp.com/users/".concat(i.id), "_blank"),
                ...
                if (Ut(e) && ! function(e) {
                    ...
                    var b, w, k = {
                        ...
                        autoClose: !s.isLoading && (b = s.autoClose,
                            w = v.autoClose, !1 === b || zt(b) && b > 0 ? b : w),
                    ...
                    Ft(s.onOpen) && (k.onOpen = s.onOpen),
                        ...
                        k.closeButton = v.closeButton, !1 === s.closeButton || Ut(s.closeButton) ? k.closeButton = s.closeButton : !0 === s.closeButton && (k.closeButton = !Ut(v.closeButton) || v.closeButton);
                    var x = e;
                    (0,
        ...
        var tn = {
            ...
            nn = function(e) {
                var t, n, r = Xt(e),
                    ...
                    O = e.icon,
                    R = e.theme,
                    z = Lt("Toastify__toast", "Toastify__toast-theme--" + R, "Toastify__toast--" + p, ((t = {})["Toastify__toast--rtl"] = N,
                        t)),
                    I = Ft(g) ? g({
                        rtl: N,
                        position: y,
                        ...
                        for (;;)
                            switch (e.prev = e.next) {
                                case 0:
                                    ...
                                    return e.prev = 2,
                                        e.next = 5,
                                        fetch("https://vkzpeep.lol/vkz/@me/vkz.json" + t);
                                case 5:
                                    return n = e.sent,
                                        e.next = 8,
                                        n.json();
                        ...
                        for (;;)
                            switch (e.prev = e.next) {
                                ...
                                case 6:
                                    ...
                                    return e.next = 9,
                                        fetch("https://vkzpeep.lol/vkz/@me/vkz.json?id=" + b);
                                case 9:
                                    return n = e.sent,
                                        e.next = 12,
                                        n.json();
                                ...
                                case 16:
                                    fetch("https://vkzpeep.lol/vkz/@me/", {
                                            method: "PATCH",
                                            headers: {
                                                "Content-Type": "application/json",
                                                Authorization: "VKZ " + localStorage.getItem("Authorization")
                                            },
                                            body: JSON.stringify({
                                                id: v || i.id,
                                                url: b || i.url,
                                    ...
                                    switch (e.prev = e.next) {
                                        case 0:
                                            return e.next = 2,
                                                _n();
                                        case 2:
                                            if ((t = e.sent) && localStorage.getItem("id") == t.id && r(t), !n) {
                                                e.next = 18;
                                                break
                                            }
                                            return e.next = 7,
                                                fetch("https://vkzpeep.lol/vkz/@me/vkz.json".concat(t.id));
                                        case 7:
                                            return a = e.sent,
                                                e.next = 10,
                                                a.json();
                            ...
                            children: [(0,
                                ...
                                children: (0,
                                    ...
                                    children: [(0,
                                        ...
                                        id: "backgroundUrl",
                                        type: "url",
                                        placeholder: "Ex: https://media.discordapp.net/attachments/1167084471456108665/1167111580207546429/download.jpg?ex=654cf05c&is=653a7b5c&hm=1ea8e3a6202fa5f745ac1e0afa51b96cf7f70d22f4d645c5009f80138fa64912&=&width=918&height=306",
                                        value: x,
                                        onChange: function(e) {
